  ...
  <div id="view" class="learn">
    <div class="container">
      <div class="row mt-5">
        <div class="col-md-12">
          <div class="titlepage">
            <h2 class="mb-3 text-center"><strong class="yellow">Pengumuman</strong></h2>
            <?php if (mysqli_num_rows($pengumumanView) > 0) {
              while ($row = mysqli_fetch_assoc($pengumumanView)) { ?>
                <div class="card mt-3">
                  <div class="card-body">
                    <blockquote class="blockquote mb-0 text-left">
                      <?= $row['isi'] ?>
                      <footer class="blockquote-footer mt-3"> <cite title="Source Title"><small>
                          <?php $dateCreate = date_create($row['created_at']);
                          echo date_format($dateCreate, "l, d M Y h:i a"); ?></small></cite></footer>
                    </blockquote>
                  </div>
                </div>
            <?php }
